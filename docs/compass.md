...
namespace `FKSEdgeThreshold.Standalone.Mathlib.InlineFKSEdgeThreshold`. Rows 8 and 9 are Mathlib's.
...
- The statement is authored, not inherited: `formal-conjectures` does not state it. Stage 1 wrote it
  ...
  (`FKSEdgeThreshold/Stage1/Equivalence.lean`). The frozen statement is A.
